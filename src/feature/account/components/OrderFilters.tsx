        ...
        <div className="pt-4 border-t border-gray-50 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <option value={ORDER_STATUS.CONFIRMED}>Đã thanh toán</option>
              <option value={ORDER_STATUS.PAID_WAITING_STOCK}>
                Chưa xử lý (Thiếu hàng)
              </option>
              ...
              {/* Đã bổ sung trạng thái Yêu cầu hủy */}
              <option value={ORDER_STATUS.CANCEL_REQUESTED}>
